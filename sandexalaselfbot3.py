...
║╚════════════
║𖤓≛≛≛≛≛≛≛≛≛≛≛≛≛𖤓
║     s҉ a҉ n҉ d҉ e҉ x҉ a҉ l҉ a҉  t҉ e҉ a҉ m҉  b҉ o҉ t҉  p҉ r҉ o҉ t҉ e҉ c҉ t҉ 
║𖤓≛≛≛≛≛≛≛≛≛≛≛≛≛𖤓
╚═════════════"""
            ...
            if op.param2 not in Bots:
              if op.param2 in Bots:
                ...
                try:
                  ...
                  cl.sendText(op.param1, "Mau Invite Siapa kk ??? \nJangan Sok Jadi Jagoan Deh Lu Njir.\nAdmin Bukan,Owner Juga Bukan\Kick Ah 😛")
                  random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
                except:
                  random.choice(KAC).cancelGroupInvitation(op.param1, gMembMids)
                  random.choice(KAC).sendText(op.param1, "Mau Invite Siapa kk ??? \nJangan Sok Jadi Jagoan Deh Lu Njir.\nAdmin Bukan,Owner Juga Bukan\Kick Ah 😛")
                  random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
...
#-------------------- Protect Mode ------------
                ...
                if wait["Protectjoin"] == True:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Kick Joined Group On􀜁??􏿿")
                else:
